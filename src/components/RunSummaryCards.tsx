  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
      {runs.map((run, i) => (
        ...
        >
          <p className={`text-[10px] uppercase tracking-widest font-sans ${i === 0 ? 'text-stone-400' : 'text-crimson'}`}>
            {run.label}
          </p>
          <div className="flex gap-6">
            <div>
              <p className="font-serif text-2xl font-bold text-ink dark:text-white">{run.score}</p>
              <p className="text-[10px] uppercase tracking-widest text-stone-400 font-sans mt-0.5">score</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-[10px] uppercase tracking-widest text-stone-400 font-sans mt-0.5">cache read</p>
            </div>
          </div>
          <div className="border-t border-stone-200 dark:border-stone-850 pt-3">
            <p className="text-[10px] uppercase tracking-widest text-stone-400 font-sans mb-1">Key miss</p>
