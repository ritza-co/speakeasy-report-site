  ...
  return (
    <div className="my-4">
      <p className="text-[10px] uppercase tracking-widest text-stone-400 font-sans mb-3">
        Score delta: vague vs precise prompt, by config
      </p>
        ...
        <table className="w-full font-sans border-collapse text-[13px]">
          <thead>
            <tr className="border-b border-stone-200 dark:border-stone-850">
              ...
              <th className="text-center py-2.5 px-4 text-[10px] uppercase tracking-widest text-stone-400 font-normal">Vague</th>
              <th className="text-center py-2.5 px-4 text-[10px] uppercase tracking-widest text-stone-400 font-normal">Precise</th>
            ...
            {DELTA_ROWS.map((row, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2.5 px-4 text-center text-stone-500">{isVisible ? row.vagueScore : '—'}</td>
                  <td className="py-2.5 px-4 text-center text-stone-500">{isVisible ? row.preciseScore : '—'}</td>
