...
const OUTCOME_STYLES: Record<string, string> = {
  ...
  neutral: 'bg-stone-50 dark:bg-stone-900 text-stone-600 dark:text-stone-400 border-stone-200 dark:border-stone-800',
}
      ...
      <div className="relative">
        ...
        <div className="space-y-2">
          {calls.map((call, i) => {
            ...
            const inner = (
              <div className={`flex-1 border rounded px-3 py-2 text-[12px] font-sans transition-opacity ${OUTCOME_STYLES[outcome]} ${call.href ? 'hover:opacity-80' : ''}`}>
            ...
            return (
              <div key={i} className="flex gap-3 items-start">
                ...
                {call.href ? (
                  <a href={call.href} target="_blank" rel="noopener noreferrer" className="flex-1 min-w-0 no-underline">
                    {inner}
                  </a>
                ) : (
